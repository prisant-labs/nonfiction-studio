// what-it-is:   Phase 1 stub for the PreToolUse hook event; replaced by TSK-032 (pre-tool-use hook)
...
if (process.env.NS_HOOK_TRACE) {
  ...
  const record = JSON.stringify({ event: 'PreToolUse', script: ownPath, stdinRaw: raw.trim() });
