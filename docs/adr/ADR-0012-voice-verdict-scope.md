...
- Status: **Accepted.** Prepared 2026-08-26 as Claude's recommendation from the design session PF-01 (voice verdict scope) reserved, after the maintainer declined to choose between the options and asked for a call. Accepted 2026-08-29 under the maintainer's delegation of that session's open decisions ("move forward with your best recommendations and decisions"); the recommendation and the acceptance therefore share an author, and this line records that provenance rather than hiding it. **Implemented 2026-09-01** (pre-publication PR 16): Decisions 1 through 4 land in code, plus the PF-25 (voice-capture write contract) and PF-14 (structured drift field) absorptions this ADR's Consequences section named.
