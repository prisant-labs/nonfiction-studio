...
OPP-P03). Unlike the other six CLIs, it never reads its input from `--project` or the working
...
by the `doctor` skill (see [doctor skill reference](../skills/doctor.md)), or by the author running
...
- [doctor skill reference](../skills/doctor.md) - the consented install path that puts
