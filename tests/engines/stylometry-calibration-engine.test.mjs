...
// The five --calibrate CLI tests below were skipped (not deleted) as a forced, minimal
// consequence of the ADR-0012 implementation wave's Task 3 (computeDrift v5): deleting
// stylometry-engine.mjs's DEFAULT_DRIFT_SCORE_MAX export (required by Task 3's design pins) made
